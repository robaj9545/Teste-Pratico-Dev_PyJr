...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Documentação para a API do Task Manager",
    "VERSION": "1.0.0",
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # opcional, seu diretório de templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Para arquivos de mídia (uploads de usuários)
MEDIA_URL = '/media/'
